# Operator Quickstart — Freshwater Fishing Fleet Operations Coordination Actor

Shortest path from clone to a verified local dry-run for **ISIC 0312** (`cloud-itonami-isic-0312`).
...
- Blueprint governor key: `freshwater-fishing-operations-governor`
- Likely source path: `freshwater_fishing.governor.cljc`
